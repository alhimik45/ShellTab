...
(function() {
  var $, State, Terminal, buff, cancel, lt_calls, s, term, term_serv,
  ...
  lt_calls.start_pty = function(pty) {
    var ctl, send;
    ...
    term_serv.on('data', function(data) {
      if (term) {
    ...
    send = function(data) {
      return term_serv.write(data);
    };
    ctl = function(type, cols, rows) {
      if (type === 'Resize') {
        return term_serv.resize(cols, rows);
      }
    };
  ...
  lt_calls.disable_pty = function() {
    return term_serv.destroy();
  };
